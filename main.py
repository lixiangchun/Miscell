...
parser.add_argument('--save_frequency', type=int, default=5, help='save frequency')
...
def main_worker(gpu, ngpus_per_node, args, x):
    ...
    augmentation = [RandomSubArrayShuffle(ratio=0.2), RandomZero(ratio=0.2)]
    train_dataset = MoCoDataset(x, TwoCropsTransform(transforms.Compose(augmentation)))
